...
return (
<div>
<div><span className='inline-flex my-2.5 ml-4 items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800'>동네질문</span></div>
...
<div>
<span className='text-sm block font-medium text-gray-700 mt-2'>Steve Jebs</span>

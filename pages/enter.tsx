...
export default function Enter() {
  ...
  return (
    <div className='mt-16 px-4'>
      <h3 className='text-3xl font-bold text-center' font-bold>Enter to Carrot</h3>
      <div className='mt-16'>
          ...
          <div className='grid border-b w-full mt-8 grid-cols-2 gap-16'>
            <button className={cls(
                ...
                method === 'email'
                 ...
                 : 'border-transparent text-gray-500' )}onClick={onEmailClick}
                 >
            ...
            <button className={cls(
                ...
                method === 'phone'
                 ? 'border-orange-500 text-orange-400' 
                 : 'border-transparent text-gray-500' )} onClick={onPhoneClick}>Phone number</button>
          </div>
        </div>

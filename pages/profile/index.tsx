    ...
    <div className="py-10 px-4">
      ...
      <div className='mt-10 flex justify-around'>
        <div className='flex flex-col items-center'>
          ...
          <span className='text-sm mt-2 font-medium text-gray-700 flex items-center justify-center'>판매내역</span>
        </div>
        <div>
        <div className='w-14 h-14 text-white bg-orange-500 rounded-full flex items-center justify-center'>
            <svg
          ...
          <span className='text-sm mt-2 font-medium text-gray-700 flex items-center justify-center'>구매내역</span>
        </div>
        <div>
        <div className='w-14 h-14 text-white bg-orange-500 rounded-full flex items-center justify-center'>
            <svg
          ...
          <span className='text-sm mt-2 font-medium text-gray-700 flex items-center justify-center'>관심목록</span>
        </div>
      </div>
      <div className='mt-12'>
        <div className='flex space-x-4 items-center'>
          ...
          <div>
            <h4 className='text-sm font-bold text-gray-800'>우시</h4>
